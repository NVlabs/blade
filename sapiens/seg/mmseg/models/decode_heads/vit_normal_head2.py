...
class VitNormalHead2(BaseDecodeHead):
    def __init__(self,
    ...
    def loss_by_feat(self, seg_logits: Tensor,
        ...
        ## used when using bfloat16 for seg_logits. converts seg_label to bfloat16
        if seg_logits.dtype != seg_label.dtype:
            seg_label = seg_label.to(seg_logits.dtype)
        ...
        valid_mask = (seg_label > losses_decode[0].eps).detach().float()
