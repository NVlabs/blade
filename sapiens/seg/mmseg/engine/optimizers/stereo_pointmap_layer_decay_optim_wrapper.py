...
def get_num_layer_for_vit(var_name, num_max_layer):
    if var_name in ('backbone.cls_token', 'backbone.mask_token',
        ...
        return layer_id + 1
    elif var_name.startswith('layers'): ## for cross attention
...
class StereoPointmapLayerDecayOptimWrapperConstructor(DefaultOptimWrapperConstructor):
    ...
    def add_params(self, params, module, prefix='', lr=None):
        ...
        for name, param in module.named_parameters():
            ...
            if name.startswith('layers'): ## for cross attention
                group_name = 'cross_attention' + group_name
            ...
            # print('name: {}, layer_id: {}, group_name: {}, lr_scale: {}, lr: {}'.format(name, layer_id, group_name, scale, scale * self.base_lr))
