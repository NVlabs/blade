...
from .utils import ImageType, _prepare_data, _stereo_pointmap_prepare_data
...
def inference_model(model: BaseSegmentor,
    ...
    """
    # prepare data
    data, is_batch = _prepare_data(img, model)
...
def stereo_pointmap_inference_model(model: BaseSegmentor,
                    img1: ImageType, img2: ImageType) -> Union[SegDataSample, SampleList]:
    # prepare data
    data, is_batch = _stereo_pointmap_prepare_data(img1, img2, model)
