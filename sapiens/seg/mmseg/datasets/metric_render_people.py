...
class MetricRenderPeopleDataset(BaseSegDataset):
    """
    """
    ...
    def load_data_list(self) -> List[dict]:
        ...
        print('\033[92mLoading MetricRenderPeople!\033[0m')
    ...
    def get_data_info(self, idx):
        ...
        depth = np.load(data_info['depth_path']) ## is not in 0 to 1. not normalized
