...
class AlbedoRenderPeopleDataset(BaseSegDataset):
    """
    """
    ...
    def load_data_list(self) -> List[dict]:
        ...
        print('\033[92mLoading AlbedoRenderPeople!\033[0m')
        ...
        common_names = rgb_files & mask_files & albedo_files
        ...
        print('\033[92mDone! AlbedoRenderPeople. Loaded total samples: {}\033[0m'.format(len(data_list)))
        return data_list
    ...
    def get_data_info(self, idx):
        ...
        ## needed as the synthetic data is constantly being generated
        if img is None or albedo is None or mask is None:
            return None
