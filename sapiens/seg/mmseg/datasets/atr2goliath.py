...
# ## https://github.com/lemondan/HumanParsing-Dataset/blob/master/atr_label.txt
ORIGINAL_SOURCE_CLASSES=('Background', 'Hat', 'Hair', 'Sunglasses',
                 'UpperClothes', 'Skirt', 'Pants', 'Dress', 'Belt',
                 'Left-shoe', 'Right-shoe', 'Face', 'Left-leg',
                 'Right-leg', 'Left-arm', 'Right-arm',
                 'Bag', 'Scarf'
                 )

#-----------------------------------------------------------------------------------------------
## Dataset renamed. Add at 0 at the end of the class name to be marked as don't care
SOURCE_CLASSES=('Background', 'Hat0', 'Hair', 'Sunglasses0',
                 'Upper_Clothing', 'Lower_Clothing', 'Lower_Clothing', 'Dress0', 'Belt0',
                 'Left_Shoe', 'Right_Shoe', 'Face_Neck', 'Left-leg0',
                 'Right-leg0', 'Left-arm0', 'Right-arm0',
                 'Bag0', 'Scarf0'
                 )
...
class ATR2GoliathDataset(BaseSegDataset):
    """LIP dataset.
    ...
    def load_data_list(self) -> List[dict]:
        ...
        print('\033[92mDone! ATR2Goliath. Loaded total samples: {}\033[0m'.format(len(data_list)))
        return data_list
