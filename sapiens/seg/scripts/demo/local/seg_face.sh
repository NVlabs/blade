...
INPUT='./demo/data/face_reel'
OUTPUT='/home/rawalk/Desktop/sapiens/seg/Outputs/vis/itw_videos/face_reel'

#--------------------------MODEL CARD---------------
MODEL_NAME='sapiens_1b'; CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/seg/checkpoints/sapiens_1b/sapiens_1b_seg_face_epoch_200.pth
