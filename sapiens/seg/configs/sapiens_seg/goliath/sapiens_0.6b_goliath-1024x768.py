...
# num_classes = 33 + 1 ## add background class
# CLASS_WEIGHT = [0.1, 10, 3, 10, 10, 3, 2, 2, 4, 4, 2, 2, 6, 10, 3, 3, 1, 0.5, 4, 4, 2, 2, 6, 10, 3, 3, 1, 1, 10, 10, 10, 10, 10, 10]
...
train_pipeline = [
    dict(type='LoadImage'),
    dict(type='RandomBackground', prob=0.8, background_images_root='/uca/sstk/vqa_non_human'),
