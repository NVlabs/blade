...
test_pipeline = [
    dict(type='mmseg.LoadImage'),
    dict(type='mmseg.Resize', scale=(768, 1024), keep_ratio=False), ## this is width x height, 768 x 1024
...
val_dataloader = dict(
    ...
    dataset=dict(
        type='GoliathDataset',
        data_root='/uca/rawalk/sapiens_lite/seg/data/goliath/',
