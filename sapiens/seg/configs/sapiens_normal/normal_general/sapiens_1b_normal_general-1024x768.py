...
pretrained_checkpoint='/uca/rawalk/sapiens_host/pretrain/checkpoints/sapiens_1b/sapiens_1b_epoch_173_clean.pth'

## dataset root path
dataset_train = dict(
        type='NormalGeneralDataset',
        data_root='/uca_transient_a/open_source_from_manifold/rawalk/sapiens_finetune/task_normal',
...
model = dict(
    ...
    decode_head=dict(
        ...
        channels=768,
        deconv_out_channels=(768, 768, 768), ## this will 2x at each step. so total is 8x
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', by_epoch=True, interval=1, max_keep_ckpts=-1), ## to save every epoch
