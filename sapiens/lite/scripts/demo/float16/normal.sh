...
SEG_DIR='/mnt/home/rawalk/Desktop/sapiens/seg/Outputs/vis/itw_videos/reel1_seg/sapiens_1b'
OUTPUT='/mnt/home/rawalk/Desktop/sapiens/seg/Outputs/vis/itw_videos/reel1_normal'

#--------------------------MODEL CARD---------------
# MODEL_NAME='sapiens_0.3b'; CHECKPOINT=$SAPIENS_CHECKPOINT_ROOT/normal/checkpoints/sapiens_0.3b/sapiens_0.3b_normal_render_people_epoch_66_dynamic_batch_$MODE.pt2
