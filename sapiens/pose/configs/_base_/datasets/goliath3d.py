...
dataset_info = dict(
    ...
    keypoint_info={
        ...
        # Right eyebrow
        72: dict(name='upper_startpoint_of_r_eyebrow', id=72, color=[255, 255, 255], type='', swap=''),
        73: dict(name='end_of_r_eyebrow', id=73, color=[255, 255, 255], type='', swap=''),
        74: dict(name='upper_midpoint_1_of_r_eyebrow', id=74, color=[255, 255, 255], type='', swap=''),
        75: dict(name='upper_midpoint_2_of_r_eyebrow', id=75, color=[255, 255, 255], type='', swap=''),
        76: dict(name='upper_midpoint_3_of_r_eyebrow', id=76, color=[255, 255, 255], type='', swap=''),

        # Left eyebrow
        77: dict(name='upper_startpoint_of_l_eyebrow', id=77, color=[255, 255, 255], type='', swap=''),
        78: dict(name='end_of_l_eyebrow', id=78, color=[255, 255, 255], type='', swap=''),
        79: dict(name='upper_midpoint_1_of_l_eyebrow', id=79, color=[255, 255, 255], type='', swap=''),
        80: dict(name='upper_midpoint_2_of_l_eyebrow', id=80, color=[255, 255, 255], type='', swap=''),
        81: dict(name='upper_midpoint_3_of_l_eyebrow', id=81, color=[255, 255, 255], type='', swap=''),

        # Nose
        82: dict(name='center_of_nose_root', id=82, color=[255, 255, 255], type='', swap=''),
        83: dict(name='tip_of_nose_bridge', id=83, color=[255, 255, 255], type='', swap=''),
        84: dict(name='midpoint_1_of_nose_bridge', id=84, color=[255, 255, 255], type='', swap=''),
        85: dict(name='midpoint_2_of_nose_bridge', id=85, color=[255, 255, 255], type='', swap=''),
        86: dict(name='midpoint_3_of_nose_bridge', id=86, color=[255, 255, 255], type='', swap=''),
        87: dict(name='center_of_labiomental_groove', id=87, color=[255, 255, 255], type='', swap=''),

        # Right eye
        88: dict(name='l_inner_end_of_upper_lash_line', id=88, color=[192, 64, 128], type='', swap='r_inner_end_of_upper_lash_line'),
        89: dict(name='l_outer_end_of_upper_lash_line', id=89, color=[192, 64, 128], type='', swap='r_outer_end_of_upper_lash_line'),
        90: dict(name='l_centerpoint_of_upper_lash_line', id=90, color=[192, 64, 128], type='', swap='r_centerpoint_of_upper_lash_line'),
        91: dict(name='l_inner_end_of_lower_lash_line', id=91, color=[64, 192, 128], type='', swap='r_inner_end_of_lower_lash_line'),
        92: dict(name='l_outer_end_of_lower_lash_line', id=92, color=[64, 192, 128], type='', swap='r_outer_end_of_lower_lash_line'),
        93: dict(name='l_centerpoint_of_lower_lash_line', id=93, color=[64, 192, 128], type='', swap='r_centerpoint_of_lower_lash_line'),

        # Left eye
        94: dict(name='r_inner_end_of_upper_lash_line', id=94, color=[64, 32, 192], type='', swap='l_inner_end_of_upper_lash_line'),
        95: dict(name='r_outer_end_of_upper_lash_line', id=95, color=[64, 32, 192], type='', swap='l_outer_end_of_upper_lash_line'),
        96: dict(name='r_centerpoint_of_upper_lash_line', id=96, color=[64, 32, 192], type='', swap='l_centerpoint_of_upper_lash_line'),
        97: dict(name='r_inner_end_of_lower_lash_line', id=97, color=[64, 192, 32], type='', swap='l_inner_end_of_lower_lash_line'),
        98: dict(name='r_outer_end_of_lower_lash_line', id=98, color=[64, 192, 32], type='', swap='l_outer_end_of_lower_lash_line'),
        99: dict(name='r_centerpoint_of_lower_lash_line', id=99, color=[64, 192, 32], type='', swap='l_centerpoint_of_lower_lash_line'),

        # Mouth
        100: dict(name='r_outer_corner_of_mouth', id=100, color=[192, 0, 0], type='', swap='l_outer_corner_of_mouth'),
        101: dict(name='l_outer_corner_of_mouth', id=101, color=[192, 0, 0], type='', swap='r_outer_corner_of_mouth'),
        102: dict(name='center_of_cupid_bow', id=102, color=[192, 0, 0], type='', swap=''),
        103: dict(name='center_of_lower_outer_lip', id=103, color=[192, 0, 0], type='', swap=''),
        104: dict(name='midpoint_1_of_upper_outer_lip', id=104, color=[192, 0, 0], type='', swap=''),
        105: dict(name='midpoint_2_of_upper_outer_lip', id=105, color=[192, 0, 0], type='', swap=''),
        106: dict(name='midpoint_1_of_lower_outer_lip', id=106, color=[192, 0, 0], type='', swap=''),
        107: dict(name='midpoint_2_of_lower_outer_lip', id=107, color=[192, 0, 0], type='', swap=''),
        108: dict(name='r_inner_corner_of_mouth', id=108, color=[0, 192, 192], type='', swap='l_inner_corner_of_mouth'),
        109: dict(name='l_inner_corner_of_mouth', id=109, color=[0, 192, 192], type='', swap='r_inner_corner_of_mouth'),
        110: dict(name='center_of_upper_inner_lip', id=110, color=[0, 192, 192], type='', swap=''),
        111: dict(name='center_of_lower_inner_lip', id=111, color=[0, 192, 192], type='', swap=''),
        112: dict(name='midpoint_1_of_upper_inner_lip', id=112, color=[0, 192, 192], type='', swap=''),
        113: dict(name='midpoint_2_of_upper_inner_lip', id=113, color=[0, 192, 192], type='', swap=''),
        114: dict(name='midpoint_1_of_lower_inner_lip', id=114, color=[0, 192, 192], type='', swap=''),
        115: dict(name='midpoint_2_of_lower_inner_lip', id=115, color=[0, 192, 192], type='', swap=''),
    },
    skeleton_info={
        0:
        dict(link=('left_ankle', 'left_knee'), id=0, color=[0, 255, 0]),
