...
class HumanImageDataset(_HumanImageDataset):
    ALLOWED_METRICS = {
        ...
        'ihmr', 'pa-pve', 'miou', 'pmiou', 'z_error', 'distortion_error'
    }
    ...
    def prepare_data(self, idx: int):
        ...
        img_dinov2 = pad_to_square(orig_img).permute(1,2,0).numpy()
        img_dinov2 = self.dinov2_transform(img_dinov2)
        img_dinov2 = resize(input=img_dinov2[None], size=(512, 512), mode="bilinear", align_corners=True)[0]
        blade_data['img_dinov2'] = img_dinov2
