...
class HumanImageDataset_Tz(_HumanImageDataset):
    ALLOWED_METRICS = {
    ...
    def prepare_raw_data(self, idx: int):
        ...
        info['has_pelvis_camcoord'] = 0
        info['pelvis_camcoord'] = np.zeros(3)
        ...
        if 'body_pose' in smpl_dict:
            info['smpl_body_pose'] = smpl_dict['body_pose'][idx].reshape((23,3))
        else:
