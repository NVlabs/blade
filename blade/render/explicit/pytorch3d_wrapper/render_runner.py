...
from .lights.builder import build_lights
from .renderers.builder import build_renderer
from .lights.lights import AmbientLights, MMLights
...
def render(renderer: Union[nn.Module, dict],
    ...
    elif isinstance(cameras, NewCamerasBase):
        cameras = cameras
    elif isinstance(cameras,
                    CamerasBase) and not isinstance(cameras, NewCamerasBase):
