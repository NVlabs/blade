...
from blade.cameras import NewCamerasBase
from mmhuman3d.utils.ffmpeg_utils import images_to_gif, images_to_video
from mmhuman3d.utils.path_utils import check_path_suffix
from blade.render.explicit.pytorch3d_wrapper.lights.builder import build_lights
from blade.render.explicit.pytorch3d_wrapper.shaders.builder import build_shader
...
class BaseRenderer(nn.Module):
    ...
    def _set_output_path(self, output_path):
        if output_path is not None:
            ...
            elif check_path_suffix(output_path, ['.png', '.jpg']):
                self.temp_path = None
            else:
    ...
    def _update_resolution(self, cameras, **kwargs):
        if isinstance(cameras, (NewCamerasBase, MMCamerasBase)):
