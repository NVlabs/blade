...
from .normal_renderer import NormalRenderer, PolarNoramlRenderer
from .opticalflow_renderer import OpticalFlowRenderer
...
RENDERER.register_module(
    name=['polar_normal', 'PolarNormal', 'PolarNoramlRenderer'],
    module=PolarNoramlRenderer)
