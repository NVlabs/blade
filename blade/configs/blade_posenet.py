...
from blade.configs.base import (root, body_model_train, test_dict_smplx,
                                ...
                                train_smplx_lessaug_morehummanpdhuman)
...
model = dict(
    ...
    # if training posenet, set the depthnet checkpoint path.
    # If testing an existing fully trained BLADE model, you could leave this as None
    depthnet_ckpt_path=None,
    # depthnet_ckpt_path=f'{root}/path/to/your/trained_depth.pth',
    do_res_aug=False,
    miou=True,
    pmiou=True,
...
data = dict(samples_per_gpu=int(os.environ['MINI_BATCHSIZE']),
            workers_per_gpu=8,
            train=train_smplx_lessaug_morehummanpdhuman,
